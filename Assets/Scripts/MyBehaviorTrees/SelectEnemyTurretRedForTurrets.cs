...
public class SelectEnemyTurretRedForTurrets : Action
{
	...
	public override TaskStatus OnUpdate()
	{
		...
		target.Value = m_ArmyElement.ArmyManager.GetFarestEnemy<Turret>(transform.position,minRadius.Value,maxRadius.Value)?.transform;
